...
int main() {
    ...
    GoodBadTeacher GoodBadTeacher1("Петрова Марина Геннадьевна", 35); // Класс не обязательно ставит только 5, просто ставит всегда какую-то определенную оценку.
    GoodBadTeacher1.addGrade(student1);
    GoodBadTeacher1.addGrade(student1);
    GoodBadTeacher1.addGrade(student2);
    GoodBadTeacher1.addGrade(student2);

    GoodBadTeacher GoodBadTeacher2("Петрова Марина Геннадьевна", 35); // Класс не обязательно ставит только 5, просто ставит всегда какую-то определенную оценку.
    GoodBadTeacher1.addGrade(student1);
    GoodBadTeacher1.addGrade(student1);
    GoodBadTeacher1.addGrade(student2);
    GoodBadTeacher1.addGrade(student2);
